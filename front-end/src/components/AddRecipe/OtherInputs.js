          ...
          <div className='other-forms'>
            <div className='left-forms'>
              ...
              <Form.Group className="mb-3" controlId="recipeTips">
                ...
                <Form.Control as="textarea" rows={3} name='tips' value={tips} onChange={handleTipsChange}/>
              </Form.Group>
            </div> 
            ...
            <div className='right-forms'>
              ...
              <Form.Group className="mb-3" controlId="recipeDescription">
                ...
                <Form.Control as="textarea" rows={3} name='method' value={method} onChange={handleMethodChange} />
              </Form.Group>

              <Form.Group className="mb-3" controlId="recipeDescription">
                <Form.Label>Ingredients</Form.Label>
                <Form.Control as="textarea" rows={3} name='ingredients' value={ingredients} onChange={handleIngredientsChange} />
              </Form.Group>
